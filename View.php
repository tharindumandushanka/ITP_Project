...
<link rel="stylesheet" type="text/css" href="../css/homestyle.css">
	...
	<body style="background:url(../images/69.jpg);background-repeat:no-repeat;background-size:cover">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                   ...
                                   <tbody>
                                    ...
                                    $qury=mysqli_query($con,"SELECT * FROM tbl_file ORDER BY id ASC");
                                    while($resalt=mysqli_fetch_array($qury)){
									?>
                                        <tr>    
											<td><?php echo $resalt['name']; ?></td>
											<td><?php echo $resalt['subject']; ?></td>
											<td><?php echo $resalt['year']; ?></td>
											<td><?php echo $resalt['pdf']; ?></td>
                                            <td><img src="../image/images/pdf.png" width="40px" height="40px"></td>
                                            <td><a href="../upload/<?php echo $resalt['pdf']; ?>" target="_blank" class="btn btn-warning" download>Download</a></td>
